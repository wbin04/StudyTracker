...
GOOGLE_OAUTH_CLIENT_ID = config('GOOGLE_OAUTH_CLIENT_ID', default='989980239432-3h0166c9bb3tok2ud28lnjb7jicf6baa.apps.googleusercontent.com')
GOOGLE_OAUTH_CLIENT_SECRET = config('GOOGLE_OAUTH_CLIENT_SECRET', default='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')
GOOGLE_OAUTH_SCOPES = [
    'openid',
